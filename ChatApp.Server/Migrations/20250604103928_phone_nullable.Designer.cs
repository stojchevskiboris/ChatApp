...
namespace ChatApp.Server.Migrations
{
    ...
    [Migration("20250604103928_phone_nullable")]
    partial class phone_nullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Models.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Models.UserContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Models.Media", b =>
                {
                    b.HasOne("ChatApp.Server.Domain.Models.Message", null)
                        .WithOne("MediaContent")
                        .HasForeignKey("ChatApp.Server.Domain.Models.Media", "MessageId");
                });
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Models.UserContact", b =>
                {
                    b.HasOne("ChatApp.Server.Domain.Models.User", "Contact")
                        .WithMany()
